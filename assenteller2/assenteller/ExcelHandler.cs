            ...
            foreach (var wps_message in tijd_WPS_unique)
            {
                ...
                if (wps_message.DeviceID == 66)
                {
                    ...
                    for (int i = 0; i < tijd_ws1.Count - 1; i++)
                    {
                        ...
                        {
                            if (DateTime.Parse(tijd.Received) - DateTime.Parse(wps_message.Timestamp) < marge)
                            {
                                richting = tijd.IO;
                                axles901 = wps_message.TotalAxles;
                                break;
                ...
                else if (wps_message.DeviceID == 75)
                {
                    ...
                    for (int i = 0; i < tijd_ws2.Count - 1; i++)
                    {
                        ...
                        {
                            var tussen = DateTime.Parse(tijd.Received) - DateTime.Parse(wps_message.Timestamp);
                            if (DateTime.Parse(tijd.Received) - DateTime.Parse(wps_message.Timestamp) < marge)
                            {
                                richting = tijd.IO;
                                axles902 = wps_message.TotalAxles;
                ...
                else if (wps_message.DeviceID == 78)
                {
                ...
                else if (wps_message.DeviceID == 77)
                {
